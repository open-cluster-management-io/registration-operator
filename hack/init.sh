...
./vendor/github.com/open-cluster-management/api/operator/v1/*.crd.yaml
"
...
MANAGED_CLUSTER_CRD_FILE="./vendor/github.com/open-cluster-management/api/operator/v1/0000_00_operator.open-cluster-management.io_klusterlets.crd.yaml"
